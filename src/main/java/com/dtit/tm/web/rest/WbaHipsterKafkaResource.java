...
@RestController
@RequestMapping("/api/wba-hipster-kafka")
public class WbaHipsterKafkaResource {

    private final Logger log = LoggerFactory.getLogger(WbaHipsterKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public WbaHipsterKafkaResource(KafkaProperties kafkaProperties) {
